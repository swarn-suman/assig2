...
(function($){
	...
	SEMICOLON.initialize = {
		...
		execFunc: function( functionName, context ) {
			let args = Array.prototype.slice.call( arguments, 2 ),	namespaces = functionName.split("."), func = namespaces.pop();
		...
		execPlugin: function( element, settings ) {
			...
			let pluginActive	= false, pluginLinkingInterval;
	...
	let $window = $(window),
		...
		stickyLogoH = $header.attr('data-sticky-logo-height') || 55,
